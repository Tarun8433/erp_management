...
class ZoomDrawerState extends State<ZoomDrawer>
  ...
  /// Drawer state
  final ValueNotifier<DrawerState> _stateNotifier = ValueNotifier(
    DrawerState.closed,
  );
  ...
  Widget get menuScreenWidget {
    ...
    if (widget.menuScreenOverlayColor != null) {
      ...
      menuScreen = ColorFiltered(
        ...
        child: ColoredBox(color: widget.menuBackgroundColor, child: menuScreen),
      );
    } else {
  ...
  Widget get mainScreenWidget {
    ...
    if (widget.shrinkMainScreen) {
      ...
      mainScreen = SizedBox(width: mainSize, child: mainScreen);
    }
  ...
  Widget _renderLayout() {
    ...
    if (!kIsWeb &&
      ...
      parentWidget = PopScope(canPop: _canPop(), child: parentWidget);
    }
